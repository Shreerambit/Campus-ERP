...
| Internet Technology (IT) | BVVS-IT | **Smt. Akshata Patil** (Akshata ma'am) | HTML5, CSS3 Flexbox/Grid, JavaScript ES6+, DOM, Fetch API, REST APIs, Web Security (XSS, SQLi) |
...
2. **Know your teachers** — Naina ma'am = DA, Praveen sir = SE, Neelkanth sir = MAD, Akshata ma'am = IT.
...
* **Faculty:** **Smt. Akshata Patil** (Akshata ma'am)
...
| **Internet Technology (IT)** | \`BVVS-IT\` | **Smt. Akshata Patil** | Full-Stack Web Development, Cloud Services |
...
Ensure your Android Studio lab projects run smoothly on emulators/physical devices. Practice building a simple CRUD app (Student Registration or Notes App).`;
  ...
  if (q.includes('it') || q.includes('internet technology') || q.includes('akshat') || q.includes('akshata') || q.includes('akashat') || q.includes('akashata')) {
