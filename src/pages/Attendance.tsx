...
export default function Attendance() {
  ...
  // Every teacher can pick ANY subject for the current semester.
  // (We used to restrict by assigned_subjects, but that caused issues
  // when the admin hadn't set them or when subject codes drifted.
  // Ownership at the DB level is enforced elsewhere.)
  const semSubjects = subjectList.filter(s => s.semester === scope.semester);
  const allowedSubjects = semSubjects;
