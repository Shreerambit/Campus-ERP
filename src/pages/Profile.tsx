...
import { Github, Linkedin, Mail, Phone, Award, Code2, Trophy, Lock, Camera, Save, ShieldCheck, KeyRound, LogOut, AlertCircle, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      <motion.div layout className="card relative overflow-hidden">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center gap-5">
          <div className="relative">
            <img src={photo} className="h-24 w-24 rounded-3xl border border-white/70 shadow-soft bg-white" />
      ...
      <section className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
          ...
          <ReadonlyField label="Roll Number"         value={String(s.sl)}/>
