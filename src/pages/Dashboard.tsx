...
import { motivationEmoji, classesNeededTo, Student } from '../lib/students';
    ...
    <div className="space-y-6">
      ...
      <motion.section layout className="card overflow-hidden relative">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center gap-5">
          <img src={s.photo} className="h-20 w-20 rounded-2xl border border-white/70 shadow-soft bg-white"/>
          <div className="flex-1 min-w-0">
            <div className="text-sm opacity-70">{TODAY}</div>
            <h1 className="h-display">{HELLO}, {s.name.split(' ')[0]} <span className="align-middle">{motivationEmoji(pct)}</span></h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="card">
          <div className="h-section mb-1">Attendance</div>
            ...
            <div>
              ...
              <div className="text-xs mt-2 opacity-70 flex items-center gap-1">
                ...
                {totalClasses === 0
                  ...
                  : need85 === 0 ? 'You are above 85% target 🎉' : `Attend ${need85} more classes to reach 85%`}
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="card">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Quick icon={<ClipboardCheck size={18}/>} title="Attendance"      desc="Trends"              to="/attendance"/>
            <Quick icon={<FileSignature size={18}/>}  title="Leave"           desc="Apply / track"       to="/leave"/>
            <Quick icon={<Wallet size={18}/>}         title="Fees"            desc="View status"         to="/profile"/>
          </div>
        </section>
